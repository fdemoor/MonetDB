...
pyapi_export PyObject *PyArrayObject_FromScalar(PyInput *input_scalar,
												char **return_message);
...
//! array)
pyapi_export PyObject *PyDict_CheckForConversion(PyObject *pResult,
...
pyapi_export PyObject *PyObject_CheckForConversion(PyObject *pResult,
												   int expected_columns,
												   int *actual_columns,
												   char **return_message);
...
pyapi_export bool PyObject_PreprocessObject(PyObject *pResult,
...
pyapi_export str PyObject_GetReturnValues(PyObject *obj,
...
pyapi_export BAT *PyObject_ConvertArrayToBAT(PyArrayObject *array,
									         int bat_type, size_t mem_size);
